...
namespace SincronizadorAplix_Nidux.models
{
    ...
    //    public EnableExtraProductsBuy EnableExtraProductsBuy { get; set; }
    //    public EnableAnonymousBuyer EnableAnonymousBuyer { get; set; }
    ...
    //public class EnableExtraProductsBuy
    //{
    //    public int Id { get; set; }
    //    public string Details { get; set; }
    //}

    //public class EnableAnonymousBuyer
    //{
    //    public int Id { get; set; }
    //    public string Details { get; set; }
    //}
    ...
    //{
    //    public Dictionary<int, Product> Available { get; set; }
    //}
